...
void
garagejam_studio_player_main(gchar *streamuri, gchar *name)
{
...
void
garagejam_studio_player_new (GstPlayer * player, const gchar * next_uri)
{
	gst_player_set_uri(player, next_uri);
}

void
garagejam_studio_player_stop (GstPlayer *player)
{
	if (player != NULL) {
...
void
garagejam_studio_player_pause (GstPlayer *player)
{
